...
const historyManagerContext = createContext<ReturnType<typeof useHistoryManager>>({ history: [], canGoBack: () => false });

export function HistoryManagerProvider({ children }: { children: any }) {
